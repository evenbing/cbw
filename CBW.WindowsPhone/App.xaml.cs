...
namespace CBW.WindowsPhone
{
    public partial class App : Application
    {
        ...
        public static MemoItem MemoTemp { get; set; }

        public static ObservableCollection<MemoItem> Memos { get; set; }
        public static ObservableCollection<FrontPageControl> Flips = new ObservableCollection<FrontPageControl>();
